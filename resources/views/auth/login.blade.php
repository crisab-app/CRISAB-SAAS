    ...
    <div class="bg-gray-800 p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-700 space-y-5 relative overflow-hidden">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-4 relative z-10">
            ...
            <div class="pt-2 border-t border-gray-700/50 mt-4">
                <label for="captcha" class="block text-xs font-bold text-gray-400 uppercase mb-2 mt-2">Resuelve el Captcha *</label>
                <div class="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
                    <div class="bg-white rounded-lg overflow-hidden border border-gray-600 inline-block shadow-sm">
                        {!! captcha_img('flat', ['class' => 'captcha-img h-12 w-auto cursor-pointer hover:opacity-90 transition', 'title' => 'Haz clic para recargar', 'onclick' => 'this.src="/captcha/flat?"+Math.random()']) !!}
                    </div>
        ...
        <div class="relative z-10 mt-6 pt-4 border-t border-gray-700">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-gray-800 text-gray-400 font-medium">O continúa con</span>
            </div>
