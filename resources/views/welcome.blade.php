...
<head>
    ...
    <title>AdministrarMe - Gestión de Iglesias</title>
...
<body class="bg-gray-50 flex flex-col min-h-screen">
    <main class="flex-grow flex items-center justify-center">
        <div class="max-w-3xl mx-auto text-center px-4">
            ...
            <p class="text-xl text-gray-600 mb-10">El sistema integral para la gestión, organización y administración de tu iglesia.</p>
